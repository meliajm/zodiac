...
public class Users implements Serializable{
	...
	public Users(int userid, String username, int password, String firstName, String lastName, Date dateOfBirth,
			String description, int gender, byte[] picture, List<Users> followers, List<Users> followees) {
		super();
		this.userid = userid;
	...
	public Users(int userid, List<Users> followers) {
		super();
		this.userid = userid;
		this.followers = followers;
	}
	...
	public List<Users> getFollowees() {
		return followees;
	}

	public void setFollowees(List<Users> followees) {
		this.followees = followees;
	}
